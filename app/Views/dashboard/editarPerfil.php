        ...
        <div id="perfil">
            ...
            <div id="gerenciarPerfil">
                ...
                <div id="dados">
                    ...
                    <form id="painel" action="<?= URL.'/dashboards/editarCliente/'. $dados['id'] ?>" method="POST">
                    <?php var_dump($dados['id']) ?>
                    <?php var_dump($dados['senha']) ?>
                        <div id="opcao">
                            <p>Dados Pessoais</p>
                        ...
                        <div id="dadosPerfil">
                            <div id="cadastro">
                                ...
                                <div id="email">
                                    <p>E-mail</p>
                                    <input type="text" name="email" placeholder="E-mail" value="<?=$dados['email']?>" />
                                </div>
                                <!-- <div id="cpfRg">
                                    <div id="cpf">
                                        <p>CPF</p>
